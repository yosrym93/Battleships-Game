...
USER_NAMES_     PROC NEAR
     ...
     INC BX
     MOV CL, BYTE PTR [BX]
     MOV P2_USERNAME+1, CL
     MOV CH, 0
     INC BX
     MOV DI, OFFSET P2_USERNAME+2
     READ_USERNAME:
        MOV AL, BYTE PTR [BX]
        MOV BYTE PTR [DI], AL
        INC BX
     ...
     ADD_BYTE_TO_SEND_BUFFER    USERNAME_CODE, CHAT_BUFFER_INDEX
     ; SEND MY USERNAME
     MOV BX, OFFSET P1_USERNAME+1
     MOV CL, BYTE PTR [BX] ; CX = USERNAME SIZE
     INC BX                ; BX -> ACTUAL USERNAME
     ADD_BYTE_TO_SEND_BUFFER    CL, CHAT_BUFFER_INDEX
     MOV CH, 0
     WRITE_USERNAME:
        MOV DL, BYTE PTR [BX]
        ADD_BYTE_TO_SEND_BUFFER DL, CHAT_BUFFER_INDEX
        INC BX
     LOOP WRITE_USERNAME 
...
INITIALIZE_SERIAL_PORT_ PROC    NEAR
    ...
    ; INITIALIZE SEND CHAT BUFFER START CHAT CODE
...
;    MOV BX,0
;EMPTYING_A_PLACE:    
;    MOV DI,OFFSET MESSAGES_QUEUE[BX]
;    MOV SI,OFFSET MESSAGES_QUEUE[BX+103]
;    MOV CX,103
;    REP MOVSB
;    ADD BX,103
;    CMP BX,1442

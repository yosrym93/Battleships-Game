...
POWER_UP_PICKER_ PROC    NEAR
    ...
    CMP CL, 1
    JZ DISPLAY_DESTROY_SHIP_MSG
    CMP CL, 2
    JZ DISPLAY_ATTACK_TWICE_MSG
    
    PRINT_NOTIFICATION_MESSAGE  REVERSED_ATTACK_MSG, 1
    JMP UPDATE_HIGHLIGHT
    
    DISPLAY_DESTROY_SHIP_MSG:
    PRINT_NOTIFICATION_MESSAGE  DESTROY_SHIP_MSG, 1
    JMP UPDATE_HIGHLIGHT
    
    DISPLAY_ATTACK_TWICE_MSG:
    ...
    ADD BX, DX 
    MOV BYTE PTR [BX], 1
    DEC N_AVAILABLE_POWER_UPS
    ; CHECH WHICK POWER UP
    CMP AH, 1
...
DRAW_POWER_UPS_CARDS_    PROC    NEAR
    ; DRAW THE CARD
    CMP N_AVAILABLE_POWER_UPS, 0
    JZ DRAW_NO_CARDS
    CMP N_AVAILABLE_POWER_UPS, 1
    JZ DRAW_ONE_CARD
    CMP N_AVAILABLE_POWER_UPS, 2
    JZ DRAW_TWO_CARDS
    CMP N_AVAILABLE_POWER_UPS, 3
    JZ DRAW_THREE_CARDS
...
GET_ATTACK_COLUMN_  PROC    NEAR
    ...
    GET_KEY_PRESSED:
        ...
        jz GET_KEY_PRESSED
        jmp ADDITIONAL_CHECK_FOR_REVERSE
        RETURN_FROM_ADDITIONAL_CHECK:
        POWER_UP_PICKER
        jmp GET_KEY_PRESSED
        
        ADDITIONAL_CHECK_FOR_REVERSE:
        CMP IS_REVERSE_ATTACK_ACTIVATED , 1
        jnz RETURN_FROM_ADDITIONAL_CHECK
        CMP IS_REVERSE_COUNT , 1
        JnZ GET_KEY_PRESSED
        jz RETURN_FROM_ADDITIONAL_CHECK

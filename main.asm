...
MAIN_MENU_     PROC NEAR
  ...
  ADD_BYTE_TO_SEND_DATA_BUFFER GAME_INVITATION_CODE
  SEND_DATA
  MOV IS_HOST, 1
  ...
  ADD_BYTE_TO_SEND_DATA_BUFFER CHAT_INVITATION_CODE
  SEND_DATA
  MOV IS_HOST, 1
  ...
  CHECK_FOR_RESPONSE:
   ...
   CANCEL_INVITATION:
   ADD_BYTE_TO_SEND_DATA_BUFFER CANCEL_INVITATION_CODE
   SEND_DATA
   ...
   ACCEPT_INVITATION:
   ADD_BYTE_TO_SEND_DATA_BUFFER ACCEPT_INVITATION_CODE
   SEND_DATA
   PRINT_NOTIFICATION_MESSAGE    YOU_ACCEPTED_MSG, 1
   JMP START_GAME_MODE  
    
   REJECT_INVITATION:
   ADD_BYTE_TO_SEND_DATA_BUFFER REJECT_INVITATION_CODE
   SEND_DATA
...
GET_LEVEL_     PROC NEAR
 ...
 PRINT_NOTIFICATION_MESSAGE CHOOSE_LEVEL_MSG, 1
  NOTVALID2:
    ...
    CMP LEVEL, 1
    JNE SEND_LEVEL2
    ADD_BYTE_TO_SEND_DATA_BUFFER    LEVEL1_CODE
    SEND_DATA
    JMP SET_LEVEL
    
    SEND_LEVEL2:
    ADD_BYTE_TO_SEND_DATA_BUFFER    LEVEL2_CODE
    SEND_DATA
    JMP SET_LEVEL
...
ADD_BYTE_TO_SEND_DATA_BUFFER_ PROC    NEAR
    ...
    ; CHECK IF THE MAXIMUM CAPACITY IS REACED
    CMP SEND_DATA_BUFFER_FULL, 1
    JE DONE_ADDING_TO_DATA_BUFER
    ...
    MOV AX, SI
    ADD AX, BUFFER_SIZE ; NOW AX = OFFSET JUST BEYOND THE BUFFER
    CMP SEND_DATA_BUFFER_PTR, AX
    JNE DONE_ADDING_TO_DATA_BUFER
    ; MAXIMUM CAPACITY REACHED
    MOV SEND_DATA_BUFFER_FULL, 1
    
    DONE_ADDING_TO_DATA_BUFER:
    RET
